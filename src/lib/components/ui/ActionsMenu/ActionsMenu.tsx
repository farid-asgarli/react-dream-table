...
export const ActionsMenu = React.forwardRef<
  HTMLDivElement,
      ...
      return (children as ActionsMenuListItem[])
        ...
        .map((elem, i) => {
          if (Object.keys(elem!).length === 0) {
            return <div key={i + "_actions_divider"} className="divider" />;
          }
          return (
            <div className="button-wrapper" key={elem?.key}>
              <button className={cs(elem.isSelected && "selected")} key={elem?.key} onClick={elem?.onClick}>
