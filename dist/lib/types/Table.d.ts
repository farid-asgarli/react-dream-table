...
export declare type ColumnType<DataType> = {
 ...
 */
export declare type ContextLocalization = {
    dataLoading: string;
...
declare type ElementStyling = {
    className?: string | undefined;
    style?: React.CSSProperties | undefined;
};
/** Set of type defintions for `Table` component. */
export declare type TableProps<DataType> = {
    ...
    renderContextMenu?: (data: DataType | undefined, selectedRows: Set<TableRowKeyType>, paginationProps: TablePaginationProps, selectedFilters: SelectedFilterType) => (ContextMenu | undefined)[];
